...
class output_display(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "General I/Q Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("General I/Q Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "output_display")
        ...
        self.tabs.addTab(self.tabs_widget_0, 'IQ Plane')
        self.tabs_widget_1 = Qt.QWidget()
        self.tabs_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tabs_widget_1)
        self.tabs_grid_layout_1 = Qt.QGridLayout()
        self.tabs_layout_1.addLayout(self.tabs_grid_layout_1)
        self.tabs.addTab(self.tabs_widget_1, 'Magnitude')
        self.tabs_widget_2 = Qt.QWidget()
        self.tabs_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tabs_widget_2)
        self.tabs_grid_layout_2 = Qt.QGridLayout()
        self.tabs_layout_2.addLayout(self.tabs_grid_layout_2)
        self.tabs.addTab(self.tabs_widget_2, 'Phase')
        ...
        self.tabs.addTab(self.tabs_widget_3, 'IQ Scope Plot')
        self.top_layout.addWidget(self.tabs)
        self._ReceiverGain_range = Range(0, 38, 1, 30, 200)
        self._ReceiverGain_win = RangeWidget(self._ReceiverGain_range, self.set_ReceiverGain, "ReceiverGain", "counter_slider", float)
        self.top_layout.addWidget(self._ReceiverGain_win)
        ...
        self.uhd_usrp_source_0.set_samp_rate(samp_rate*4)
        self.uhd_usrp_source_0.set_center_freq(200000000, 0)
        self.uhd_usrp_source_0.set_gain(ReceiverGain, 0)
        ...
        self.tabs_layout_3.addWidget(self._qtgui_time_sink_x_0_0_0_0_win)
        ...
        self.tabs_layout_2.addWidget(self._qtgui_time_sink_x_0_0_0_win)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_arg_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_usrp_source_0.set_samp_rate(self.samp_rate*4)
    ...
    def set_ReceiverGain(self, ReceiverGain):
        ...
        self.uhd_usrp_source_0.set_gain(self.ReceiverGain, 0)
